package com.mycompany.login.Vista;

import com.mycompany.login.Controlador.CrtlAgg;
...
public class FrmAgg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtcontra, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 130, 120, 30));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void lblGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblGuardarMouseClicked
        ctrlAgg.IngresarDatos(this.txtNombre.getText(), this.txtcontra.getText());
        vaciar();
