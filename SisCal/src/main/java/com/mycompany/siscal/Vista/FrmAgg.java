package com.mycompany.siscal.Vista;

import com.mycompany.siscal.Controlador.CrtlAgg;
...
public class FrmAgg extends javax.swing.JFrame {
    ...
    private void lblGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblGuardarMouseClicked
        ctrlAgg.IngresarDatos(this.txtNombre.getText(), this.txtMat.getText(), Float.parseFloat(this.txtCal.getText()));
